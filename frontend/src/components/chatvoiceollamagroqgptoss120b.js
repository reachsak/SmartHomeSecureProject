...
export const Chatvoiceollamagroqgptoss120b = () => {
...
then provide a short summary of what was changed.`,
  ...
  const handleFileSelect = (e) => {
    ...
    if (file) {
      ...
      setYamlContent(""); // reset previous content until submit
    }
  };
  ...
  return (
    <div className="App">
      <Box
        ...
        alignItems="center"
      >
        <h2>SmartHomeSecure Assistant GTP-OSS 120b</h2>
